 ...
 */
final class Version20231019142407 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE pricing_plan (id INT NOT NULL, name VARCHAR(255) NOT NULL, price INT NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE pricing_plan_benefit (id INT NOT NULL, pricing_plan_id INT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_E6A62C5F29628C71 ON pricing_plan_benefit (pricing_plan_id)');
        $this->addSql('CREATE TABLE pricing_plan_feature (id INT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql("INSERT INTO pricing_plan VALUES(nextval('pricing_plan_id_seq'),'Enterprise',30)");

        $this->addSql("INSERT INTO pricing_plan_benefit VALUES(nextval('pricing_plan_benefit_id_seq'),1,'10 Users included')");
        $this->addSql("INSERT INTO pricing_plan_benefit VALUES(nextval('pricing_plan_benefit_id_seq'),1,'2 GB included')");
        $this->addSql("INSERT INTO pricing_plan_benefit VALUES(nextval('pricing_plan_benefit_id_seq'),1,'E-Mail support')");
        $this->addSql("INSERT INTO pricing_plan_benefit VALUES(nextval('pricing_plan_benefit_id_seq'),1,'Help center available')");

        $this->addSql("INSERT INTO pricing_plan_benefit VALUES(nextval('pricing_plan_benefit_id_seq'),2,'20 Users included')");
        $this->addSql("INSERT INTO pricing_plan_benefit VALUES(nextval('pricing_plan_benefit_id_seq'),2,'10 GB included')");
        $this->addSql("INSERT INTO pricing_plan_benefit VALUES(nextval('pricing_plan_benefit_id_seq'),2,'E-Mail support')");
        $this->addSql("INSERT INTO pricing_plan_benefit VALUES(nextval('pricing_plan_benefit_id_seq'),2,'Help center available')");

        $this->addSql("INSERT INTO pricing_plan_benefit VALUES(nextval('pricing_plan_benefit_id_seq'),3,'120 Users included')");
        $this->addSql("INSERT INTO pricing_plan_benefit VALUES(nextval('pricing_plan_benefit_id_seq'),3,'100 GB included')");
        $this->addSql("INSERT INTO pricing_plan_benefit VALUES(nextval('pricing_plan_benefit_id_seq'),3,'E-Mail support')");
        $this->addSql("INSERT INTO pricing_plan_benefit VALUES(nextval('pricing_plan_benefit_id_seq'),3,'Help center available')");
